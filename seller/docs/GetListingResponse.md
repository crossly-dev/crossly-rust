...
------------ | ------------- | ------------- | -------------
**platform_listings** | [**Vec<crate::models::GetListingResponsePlatformListings>**](GetListingResponse_platformListings.md) |  | 
**id** | **String** |  | 
...
**tags** | **Vec<String>** |  | 
**price_floor_cents** | Option<**f32**> |  | [optional]
**floor_is_net** | **bool** |  | 
...
**grade_key** | Option<**String**> |  | [optional]
**grading** | Option<[**crate::models::ListListingsItemGrading**](ListListingsItem_grading.md)> |  | [optional]
**publish_at** | Option<**String**> |  | [optional]
**scheduled_platforms** | Option<**Vec<String>**> |  | [optional]
**parent_listing_id** | Option<**String**> |  | [optional]
**is_bundle** | **bool** |  | 
**automation_assigned_rule_ids** | **Vec<String>** |  | 
...
**country_of_origin** | Option<**String**> |  | [optional]
**delisted_at** | Option<**String**> |  | [optional]
**sold_at** | Option<**String**> |  | [optional]
**duplicate_of_listing_id** | Option<**String**> |  | [optional]
**client_draft_id** | Option<**String**> |  | [optional]

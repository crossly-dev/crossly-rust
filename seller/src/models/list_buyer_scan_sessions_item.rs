...
pub struct ListBuyerScanSessionsItem {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "device")]
    pub device: String,
...
impl ListBuyerScanSessionsItem {
    pub fn new(id: String, device: String, started_at: String, capture_count: f32, live: bool) -> ListBuyerScanSessionsItem {

...
pub struct CreateConnectionEmailImapTestResponse {
...
impl CreateConnectionEmailImapTestResponse {
    pub fn new(success: bool, message: String) -> CreateConnectionEmailImapTestResponse {

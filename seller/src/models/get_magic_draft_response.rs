...
pub struct GetMagicDraftResponse {
    #[serde(rename = "draft")]
    pub draft: Box<crate::models::GetMagicDraftResponseDraft>,
}

impl GetMagicDraftResponse {
    pub fn new(draft: crate::models::GetMagicDraftResponseDraft) -> GetMagicDraftResponse {

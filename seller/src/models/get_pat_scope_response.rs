...
pub struct GetPatScopeResponse {
    #[serde(rename = "scopes")]
    pub scopes: Vec<crate::models::GetPatScopeResponseScopes>,
}

impl GetPatScopeResponse {
    pub fn new(scopes: Vec<crate::models::GetPatScopeResponseScopes>) -> GetPatScopeResponse {
        GetPatScopeResponse {
            scopes,
        }
    }

...
pub struct CreatePlatformAccountDisconnectResponse {
    #[serde(rename = "archived")]
    pub archived: f32,
}

impl CreatePlatformAccountDisconnectResponse {
    pub fn new(archived: f32) -> CreatePlatformAccountDisconnectResponse {

...
pub struct CreateBuyerOfferResponse {
    #[serde(rename = "data")]
    pub data: Box<crate::models::CreateBuyerOfferResponseData>,
}

impl CreateBuyerOfferResponse {
    pub fn new(data: crate::models::CreateBuyerOfferResponseData) -> CreateBuyerOfferResponse {

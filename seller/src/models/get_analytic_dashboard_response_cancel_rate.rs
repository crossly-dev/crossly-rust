...
pub struct GetAnalyticDashboardResponseCancelRate {
...
impl GetAnalyticDashboardResponseCancelRate {
    pub fn new(current: f32, previous: f32) -> GetAnalyticDashboardResponseCancelRate {

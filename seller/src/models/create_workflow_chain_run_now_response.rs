...
pub struct CreateWorkflowChainRunNowResponse {
...
impl CreateWorkflowChainRunNowResponse {
    pub fn new(success: bool, run_id: String) -> CreateWorkflowChainRunNowResponse {

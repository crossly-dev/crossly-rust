...
pub struct GetInboxConversationMessageResponse {
    #[serde(rename = "messages")]
    pub messages: Vec<crate::models::GetInboxConversationMessageResponseMessages>,
}

impl GetInboxConversationMessageResponse {
    pub fn new(messages: Vec<crate::models::GetInboxConversationMessageResponseMessages>) -> GetInboxConversationMessageResponse {

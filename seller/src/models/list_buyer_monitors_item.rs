...
pub struct ListBuyerMonitorsItem {
    #[serde(rename = "active")]
    pub active: bool,
...
impl ListBuyerMonitorsItem {
    pub fn new(active: bool, match_count: f32, created_at: String, id: String, name: String, kind: Kind, delivery: Delivery) -> ListBuyerMonitorsItem {

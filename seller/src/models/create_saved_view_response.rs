...
impl CreateSavedViewResponse {
    pub fn new(id: String, name: String, created_at: String, updated_at: String, user_id: String, is_default: bool, sort_order: f32, resource: String) -> CreateSavedViewResponse {

...
pub struct GetBuyerScanSessionResponseIdentifier {
    #[serde(rename = "ns")]
    pub ns: String,
    #[serde(rename = "value")]
    pub value: String,
...
impl GetBuyerScanSessionResponseIdentifier {
    pub fn new(ns: String, value: String) -> GetBuyerScanSessionResponseIdentifier {

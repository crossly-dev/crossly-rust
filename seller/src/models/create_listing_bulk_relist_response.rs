...
pub struct CreateListingBulkRelistResponse {
...
impl CreateListingBulkRelistResponse {
    pub fn new(message: String, bulk_job_id: crate::models::Null) -> CreateListingBulkRelistResponse {

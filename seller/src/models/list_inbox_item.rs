...
impl ListInboxItem {
    pub fn new(id: String, created_at: String, user_id: String, status: String, platform: String, account_slot: f32, platform_conversation_id: String, is_read: bool, is_hidden: bool, has_offer: bool) -> ListInboxItem {
        ListInboxItem {
            id,
            created_at,
            user_id,

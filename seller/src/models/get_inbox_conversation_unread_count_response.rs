...
pub struct GetInboxConversationUnreadCountResponse {
    #[serde(rename = "count")]
    pub count: f32,
}

impl GetInboxConversationUnreadCountResponse {
    pub fn new(count: f32) -> GetInboxConversationUnreadCountResponse {

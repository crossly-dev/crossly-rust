...
pub struct CreateAiGenerateListingResponseSuggestedPrice {
    #[serde(rename = "value")]
    pub value: f32,
...
impl CreateAiGenerateListingResponseSuggestedPrice {
    pub fn new(value: f32, confidence: f32) -> CreateAiGenerateListingResponseSuggestedPrice {

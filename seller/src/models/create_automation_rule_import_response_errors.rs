...
pub struct CreateAutomationRuleImportResponseErrors {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "errors")]
...
impl CreateAutomationRuleImportResponseErrors {
    pub fn new(name: String, errors: Vec<serde_json::Value>) -> CreateAutomationRuleImportResponseErrors {

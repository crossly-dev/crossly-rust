...
pub struct GetConnectionEmailResponseOauth {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub _type: String,
...
impl GetConnectionEmailResponseOauth {
    pub fn new(id: String, _type: String, is_connected: bool, email: String) -> GetConnectionEmailResponseOauth {

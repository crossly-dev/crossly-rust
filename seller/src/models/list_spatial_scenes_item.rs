...
pub struct ListSpatialScenesItem {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "kind")]
    pub kind: String,
...
impl ListSpatialScenesItem {
    pub fn new(id: String, kind: String, name: String, visibility: String, updated_at: String) -> ListSpatialScenesItem {

...
pub struct GetCbxSubjectSpentResponse {
    #[serde(rename = "spentBaseUnits")]
    pub spent_base_units: String,
}

impl GetCbxSubjectSpentResponse {
    pub fn new(spent_base_units: String) -> GetCbxSubjectSpentResponse {

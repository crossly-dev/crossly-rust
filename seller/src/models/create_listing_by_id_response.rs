...
pub struct CreateListingByIdResponse {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::CreateListingByIdResponseItems>,
}

impl CreateListingByIdResponse {
    pub fn new(items: Vec<crate::models::CreateListingByIdResponseItems>) -> CreateListingByIdResponse {

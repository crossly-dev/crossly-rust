...
pub struct GetTaxonomyCategoryResponse {
    #[serde(rename = "categories")]
    pub categories: Vec<crate::models::GetTaxonomyCategoryResponseCategories>,
}

impl GetTaxonomyCategoryResponse {
    pub fn new(categories: Vec<crate::models::GetTaxonomyCategoryResponseCategories>) -> GetTaxonomyCategoryResponse {

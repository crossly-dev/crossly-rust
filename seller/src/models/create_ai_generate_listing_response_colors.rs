...
pub struct CreateAiGenerateListingResponseColors {
    #[serde(rename = "value")]
...
impl CreateAiGenerateListingResponseColors {
    pub fn new(value: Vec<String>, confidence: f32) -> CreateAiGenerateListingResponseColors {

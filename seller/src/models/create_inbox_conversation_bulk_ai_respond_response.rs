...
pub struct CreateInboxConversationBulkAiRespondResponse {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::CreateInboxConversationBulkAiRespondResponseResults>,
}

impl CreateInboxConversationBulkAiRespondResponse {
    pub fn new(results: Vec<crate::models::CreateInboxConversationBulkAiRespondResponseResults>) -> CreateInboxConversationBulkAiRespondResponse {

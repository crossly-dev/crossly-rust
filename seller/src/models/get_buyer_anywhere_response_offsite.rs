...
pub struct GetBuyerAnywhereResponseOffsite {
...
impl GetBuyerAnywhereResponseOffsite {
    pub fn new(store_id: String, host: String, store_name: String, title: String, price_cents: f32, currency: String, url: String, buyer_cashback_cents: f32, delivered_cents: f32, shipping_unknown: bool) -> GetBuyerAnywhereResponseOffsite {

...
pub struct GetPayoutEstimateResponse {
...
impl GetPayoutEstimateResponse {
    pub fn new(platform: String, gross_cents: f32, fee_cents: f32, fee_source: FeeSource, shipping_cents: f32, shipping_source: ShippingSource, net_cents: f32, take_home_pct: f32, assumptions: Vec<String>) -> GetPayoutEstimateResponse {

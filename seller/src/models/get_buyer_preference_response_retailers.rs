...
pub struct GetBuyerPreferenceResponseRetailers {
    #[serde(rename = "host")]
    pub host: String,
    #[serde(rename = "looks")]
    pub looks: f32,
...
impl GetBuyerPreferenceResponseRetailers {
    pub fn new(host: String, looks: f32) -> GetBuyerPreferenceResponseRetailers {

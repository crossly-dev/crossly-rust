...
pub struct CreateAiExtractReceiptResponse {
    #[serde(rename = "error")]
    pub error: Box<crate::models::CreateAiExtractReceiptResponseError>,
}

impl CreateAiExtractReceiptResponse {
    pub fn new(error: crate::models::CreateAiExtractReceiptResponseError) -> CreateAiExtractReceiptResponse {

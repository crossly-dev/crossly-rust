...
impl ListActionLogItem {
    pub fn new(id: String, created_at: String, status: String, source: String, action: String, category: String, correlation_id: String) -> ListActionLogItem {
        ListActionLogItem {
            id,
            created_at,
            user_id: None,

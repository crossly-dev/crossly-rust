...
pub struct CreateListingCheckDuplicateResponse {
    #[serde(rename = "matches")]
    pub matches: Vec<crate::models::CreateListingCheckDuplicateResponseMatches>,
}

impl CreateListingCheckDuplicateResponse {
    pub fn new(matches: Vec<crate::models::CreateListingCheckDuplicateResponseMatches>) -> CreateListingCheckDuplicateResponse {

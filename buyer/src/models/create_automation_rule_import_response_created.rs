...
pub struct CreateAutomationRuleImportResponseCreated {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl CreateAutomationRuleImportResponseCreated {
    pub fn new(id: String, name: String) -> CreateAutomationRuleImportResponseCreated {

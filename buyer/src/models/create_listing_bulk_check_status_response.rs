...
pub struct CreateListingBulkCheckStatusResponse {
...
impl CreateListingBulkCheckStatusResponse {
    pub fn new(message: String, bulk_job_id: crate::models::Null) -> CreateListingBulkCheckStatusResponse {

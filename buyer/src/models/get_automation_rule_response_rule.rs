...
pub struct GetAutomationRuleResponseRule {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl GetAutomationRuleResponseRule {
    pub fn new(id: String, name: String, created_at: String, updated_at: String, user_id: String, is_active: bool, trigger_type: String, action_type: String, run_count: f32) -> GetAutomationRuleResponseRule {

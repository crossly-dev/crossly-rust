...
pub struct CreateAiEnhanceTitleResponse {
    #[serde(rename = "enhancedTitle")]
    pub enhanced_title: String,
}

impl CreateAiEnhanceTitleResponse {
    pub fn new(enhanced_title: String) -> CreateAiEnhanceTitleResponse {

...
pub struct CreateListingBulkCrosspostResponse {
...
impl CreateListingBulkCrosspostResponse {
    pub fn new(message: String, bulk_job_id: crate::models::Null) -> CreateListingBulkCrosspostResponse {

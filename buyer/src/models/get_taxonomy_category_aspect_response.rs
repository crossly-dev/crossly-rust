...
pub struct GetTaxonomyCategoryAspectResponse {
    #[serde(rename = "aspects")]
    pub aspects: Vec<crate::models::GetTaxonomyCategoryAspectResponseAspects>,
}

impl GetTaxonomyCategoryAspectResponse {
    pub fn new(aspects: Vec<crate::models::GetTaxonomyCategoryAspectResponseAspects>) -> GetTaxonomyCategoryAspectResponse {

...
pub struct GetListingVariationGroupResponse {
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<Box<crate::models::GetListingVariationGroupResponseGroup>>,
}

impl GetListingVariationGroupResponse {
    pub fn new() -> GetListingVariationGroupResponse {

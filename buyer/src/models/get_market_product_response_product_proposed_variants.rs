...
pub struct GetMarketProductResponseProductProposedVariants {
    #[serde(rename = "label")]
    pub label: String,
...
impl GetMarketProductResponseProductProposedVariants {
    pub fn new(label: String) -> GetMarketProductResponseProductProposedVariants {

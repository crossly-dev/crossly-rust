...
pub struct CreateOrderImportResponse {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::CreateOrderImportResponseResults>,
}

impl CreateOrderImportResponse {
    pub fn new(results: Vec<crate::models::CreateOrderImportResponseResults>) -> CreateOrderImportResponse {

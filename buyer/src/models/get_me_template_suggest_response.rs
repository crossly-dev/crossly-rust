...
pub struct GetMeTemplateSuggestResponse {
    #[serde(rename = "template")]
    pub template: crate::models::Null,
}

impl GetMeTemplateSuggestResponse {
    pub fn new(template: crate::models::Null) -> GetMeTemplateSuggestResponse {

...
pub struct CreateInventoryUnitLookupResponse {
    #[serde(rename = "found")]
    pub found: bool,
    #[serde(rename = "reason")]
    pub reason: String,
...
impl CreateInventoryUnitLookupResponse {
    pub fn new(found: bool, reason: String) -> CreateInventoryUnitLookupResponse {

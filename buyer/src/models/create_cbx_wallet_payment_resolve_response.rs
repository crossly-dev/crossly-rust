...
pub struct CreateCbxWalletPaymentResolveResponse {
    #[serde(rename = "resolved")]
    pub resolved: bool,
}

impl CreateCbxWalletPaymentResolveResponse {
    pub fn new(resolved: bool) -> CreateCbxWalletPaymentResolveResponse {

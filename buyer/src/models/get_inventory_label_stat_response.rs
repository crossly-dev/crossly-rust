...
pub struct GetInventoryLabelStatResponse {
    #[serde(rename = "labels")]
    pub labels: Vec<crate::models::GetInventoryLabelStatResponseLabels>,
}

impl GetInventoryLabelStatResponse {
    pub fn new(labels: Vec<crate::models::GetInventoryLabelStatResponseLabels>) -> GetInventoryLabelStatResponse {

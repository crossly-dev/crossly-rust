...
pub struct CreateInventoryBulkLabelResponse {
...
impl CreateInventoryBulkLabelResponse {
    pub fn new(success: bool, updated: f32, bulk_job_id: String) -> CreateInventoryBulkLabelResponse {

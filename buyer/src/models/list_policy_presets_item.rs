...
pub struct ListPolicyPresetsItem {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl ListPolicyPresetsItem {
    pub fn new(id: String, name: String, created_at: String, updated_at: String, user_id: String, is_default: bool, kind: String) -> ListPolicyPresetsItem {

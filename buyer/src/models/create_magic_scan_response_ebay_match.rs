...
pub struct CreateMagicScanResponseEbayMatch {
    #[serde(rename = "itemId")]
    pub item_id: String,
...
impl CreateMagicScanResponseEbayMatch {
    /// Top eBay match (or null when eBay returned zero). Drives the  synthesize step's title/brand/price seed.
    pub fn new(item_id: String, title: String, item_url: String) -> CreateMagicScanResponseEbayMatch {

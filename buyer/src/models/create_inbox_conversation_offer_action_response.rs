...
pub struct CreateInboxConversationOfferActionResponse {
    #[serde(rename = "conversation")]
    pub conversation: Box<crate::models::UpdateInboxConversationResponseConversation>,
}

impl CreateInboxConversationOfferActionResponse {
    pub fn new(conversation: crate::models::UpdateInboxConversationResponseConversation) -> CreateInboxConversationOfferActionResponse {

...
pub struct CreateWorkflowChainToggleResponse {
    #[serde(rename = "chain")]
    pub chain: Box<crate::models::CreateWorkflowChainToggleResponseChain>,
}

impl CreateWorkflowChainToggleResponse {
    pub fn new(chain: crate::models::CreateWorkflowChainToggleResponseChain) -> CreateWorkflowChainToggleResponse {

...
pub struct CreateListingBulkUpdateResponse {
...
impl CreateListingBulkUpdateResponse {
    pub fn new(success: bool, updated: f32, bulk_job_id: String) -> CreateListingBulkUpdateResponse {

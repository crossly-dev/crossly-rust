...
pub struct CreateListingBulkHardDeleteResponse {
...
impl CreateListingBulkHardDeleteResponse {
    pub fn new(success: bool, deleted: f32, bulk_job_id: String) -> CreateListingBulkHardDeleteResponse {
